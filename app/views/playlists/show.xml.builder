xml.player :autoStart => 'yes', :canRate => '', :owner => @playlist.owner.id, :numResults => @playlist.songs_count, :playlist_name => @playlist.name, :rating => @playlist.rating_cache, :station_id => @playlist.station.id, :playlist_id => @playlist.id, :ownerName => @playlist.owner.name do
