...
class Site < ActiveRecord::Base
  ...
  has_many :top_playlists, :through => :summary_top_playlists, :class_name => 'Playlist', :foreign_key => 'playlist_id', :source => :playlist, :order => 'top_playlists.total_requests DESC', :conditions => 'playlists.deleted_at IS NULL and accounts.deleted_at IS NULL'
